    ...
    return (
        <>
            ...
            {isVisible ?
                ...
                <button
                    className="text-base bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-xl focus:outline-none focus:shadow-outline md:text-base sm:text-base"
                    onClick={() => {
                        if (!isAuthenticated) {
                            navigate('/login');
                        } else {
