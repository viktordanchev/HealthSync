...
function SessionMessage() {
    ...
    return (
        <div className={`${!isVisible ? 'hidden' : 'animate-bounce-left-right'} z-50 rounded-xl h-32 w-64 bg-white border-2 border-red-500 fixed left-6 bottom-6 flex flex-col items-center justify-center space-y-3 sm:left-0 sm:bottom-0 sm:w-full sm:top-0`}>
            <span className="text-lg font-bold text-black">{authErrors.SessionEnd}</span>
