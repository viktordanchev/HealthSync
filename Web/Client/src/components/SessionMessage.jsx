...
function SessionMessage({ message }) {
    ...
    return (
        <div className={`${!isVisible ? 'hidden' : ''} z-50 rounded-xl h-32 w-64 bg-white border-4 border-red-500 fixed left-6 bottom-6 flex flex-col items-center justify-center space-y-3 sm:left-0 sm:bottom-0 sm:w-full sm:top-0`}>
