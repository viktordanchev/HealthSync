...
function SessionMessage() {
    ...
    return (
        <>
            {showSessionMessage && (
                <div className="fixed left-6 bottom-6 flex flex-col items-center justify-between p-3 text-gray-700 shadow-xl animate-bounce-left-right z-50 rounded-xl h-36 w-72 bg-gray-200 bg-opacity-75 border border-zinc-500 sm:w-auto sm:left-3 sm:bottom-3 sm:right-3">
