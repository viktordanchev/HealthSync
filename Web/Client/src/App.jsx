            ...
            {loading ? <Loading /> :
                <Router>
                    ...
                    <Routes>
                        ...
                        <Route path="/account/verify" element={isUserAuthenticated ? <Navigate to="/home" /> : <Verification />} />
                        <Route path="/account/recoverPassword" element={isUserAuthenticated ? <Navigate to="/home" /> : <RecoverPassword />} />
                    </Routes>
                    <Footer />
                </Router >}
        </>
