...
function UserManage({ userName, userRoles }) {
    ...
    return (
        <article className="relative" ref={menuRef}>
            ...
            <div className={`absolute right-0 z-40 w-52 border border-zinc-500 rounded-xl shadow-xl shadow-gray-300 bg-white bg-opacity-100 transition-all duration-300 transform sm:w-full ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[-10px] pointer-events-none'
                    }`}>
